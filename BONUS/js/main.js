...
if (eta < 18)
{
    ...
    document.getElementById("totalprice-barred").innerHTML = (price.toFixed(2) + " €");
    document.getElementById("price-reduced").innerHTML = ((price * 0.8).toFixed(2) + " €");
}
else if (eta >= 65)
{
    console.log("prezzo ridotto: " + (price * 0.6).toFixed(2) + " €");
    document.getElementById("totalprice-barred").innerHTML = (price.toFixed(2) + " €");
    document.getElementById("price-reduced").innerHTML = ((price * 0.6).toFixed(2) + " €");
}
else
{
